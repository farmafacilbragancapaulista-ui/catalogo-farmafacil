...
export default function SearchPage() {
  ...
  const results = useMemo(() => {
    ...
    // pequena normalização para ignorar plural/singular simples
  ...
  return (
    <div className="space-y-4">
      <section className="space-y-2">
        <h1 className="text-xl font-bold text-slate-900 sm:text-2xl">Resultados da busca</h1>
        <input
          value={query}
      ...
      {loading ? (
        <p className="py-8 text-center text-sm text-slate-500">Carregando produtos para busca...</p>
      ) : (
